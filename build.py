...
SPHERES = [
 ...
 ("population-dynamics","POP · Population Dynamics"),("octopus","OCT · The Octopus"),("mitochondria","MTO · Mitochondria"),("cron","CRN · The Cron Job"),("the-terminal","TTY · The Terminal"),("momus","MOM · The Peer (Momus)"),
